...
//   useEffect(() => {
//     if (searchedParcel) {
//       map.fitBounds(searchedParcel.coordinates.coordinates[0]);
//     }
//   }, [searchedParcel, map]);
...
//             <Polygon
//               key={parcel.id}
//               positions={parcel.coordinates.coordinates[0]}
//               eventHandlers={{
//                 click: () => handleParcelSelect(parcel),
//               }}
//               pathOptions={{
//                 color: state.selectedParcel && state.selectedParcel.id === parcel.id ? 'red' : 'blue',
//                 weight: state.selectedParcel && state.selectedParcel.id === parcel.id ? 3 : 1,
//               }}
//             >
//               <Popup>
//                 <h3>{parcel.name}</h3>
